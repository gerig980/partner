  ...
  <div class="app-menu navbar-menu">
    ...
    <div id="scrollbar">
        ...
        <div class="container-fluid">
            ...
            @endif
            <li class="nav-item">
                <a class="nav-link" href="{{route('brands.back')}}">
                    <span data-key="t-roles">Brande</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('products.back')}}">
                    <span data-key="t-roles">Produkte</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="{{ route('activities.back') }}">
                    <span data-key="t-roles">Aktivitete</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="{{ route('categories') }}">
                    <span data-key="t-roles">Kategori</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link"  href="{{ route('contacts') }}">
                    <span data-key="t-roles">Kontakte</span>
                </a>
            </li>
