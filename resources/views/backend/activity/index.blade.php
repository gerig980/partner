...
@section('title', 'Aktivitete')
@section('content')
    <!-- start page title -->
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Aktivitete</h4>
    
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">CRM</a></li>
                        <li class="breadcrumb-item active">Aktivitete</li>
                    </ol>
                </div>
                <div class="row g-4 align-items-center">
                    <div class="col-sm-auto ms-auto">
                        <div class="hstack gap-2">
                            <button type="button" class="btn btn-success add-btn"  onclick = "window.location.href='{{ route('activity.create') }}';"><i class="ri-add-line align-bottom me-1"></i>Shto Aktivitete</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(function () {
          ...
          var table = $('.yajra-datatable').DataTable({
            ...
            columns: [
                ...
                render:function(data){
                    return "<img src=\"{{ URL::asset('images/activities/') }}/" + data + "\" height=\"50\"/>";
                }
